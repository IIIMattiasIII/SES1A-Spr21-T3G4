...
public class Search {
    ELMS model;
    ObservableList<Book> availableBooks = FXCollections.observableArrayList(); // Book class

    //constructors
    // This was brought back in because we need a way for the search class to have access to the list of availableBooks
